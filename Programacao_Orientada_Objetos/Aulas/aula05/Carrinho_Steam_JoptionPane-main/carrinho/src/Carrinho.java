...
public class Carrinho {
    ...
    public void adicionarProduto(Jogo jogo){
        ...
        JOptionPane.showMessageDialog(null, "O produto: "+ jogo.getNome()+ " foi adicionado ao carrinho!" );
    }
    ...
    public void removerProdutoDoCarrinho(int idProduto){
        for (int i = 0; i < jogos.size(); i++) {
            if(jogos.get(i).getId() == idProduto){
                ...
                JOptionPane.showMessageDialog(null, "Produto: " + jogos.get(i).getNome() + " removido com sucesso!");
                jogos.remove(i);
                return;
            }
        }
        JOptionPane.showMessageDialog(null, "O produto informado não existe no carrinho...");
    }
